    ...
    */
	...
	async _resetEntity(key) {
		try {
			...
			throw new CacheManagerError('Error when resetting a specific entity.', CacheManagerError.codes.UNRESET_DATA);
		}
	}
	...
	*/
	async _resetAll() {
		try {
			...
			throw new CacheManagerError('Error when resetting all data.', CacheManagerError.codes.UNRESET_DATA);
		}
	}
